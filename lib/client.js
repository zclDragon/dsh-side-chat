	...
	factory: (require) => {
		...
		*/
		function SideChatPanel({ sessions, api }) {
			const parentId = (0, react.useSyncExternalStore)((fn) => sessions.list.subscribe(fn), () => sessions.list.getSnapshot()).current;
